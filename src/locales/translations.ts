export const translations = {
  en: {
    ...
    modelDownloadFailed: 'Failed to download model: {{error}}',
    modelDownloadRequiredTitle: 'Download model before tagging',
    modelDownloadRequiredMessage: 'The selected model {{model}} is not downloaded yet. Download it now and continue tagging?',
    tagModelMissingMessage: 'Cannot tag. Please download the selected model first.',
  ...
  zh: {
    ...
    autoColor: '自动取色',
    modelDownloading: '正在下载 {{model}}',
    modelDownloaded: '已下载',
    modelNotDownloaded: '未下载',
    downloadModel: '下载模型',
    modelDownloadFailed: '模型下载失败：{{error}}',
    modelDownloadRequiredTitle: '打标前需要下载模型',
    modelDownloadRequiredMessage: '当前选择的模型 {{model}} 尚未下载。是否现在下载并继续打标？',
    tagModelMissingMessage: '无法打标，请先下载对应的模型。',
    // 对话框
