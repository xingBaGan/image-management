  ...
  return (
    <div ref={filterRef} className="flex items-center space-x-2">
      <button
        ...
        className="p-2 text-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-sky-400"
        title={t('openConfig')}
        ...
        <button
          ...
          className={`p-2 rounded-lg text-gray-600 ${
            isFilterOpen || getFilterCount() > 0
              ? 'bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-sky-400'
              : 'hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-sky-400'
          }`}
